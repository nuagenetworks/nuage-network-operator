...
var log = logf.Log.WithName("controller_clusternetwork")
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	c, err := controller.New("clusternetwork-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}

	// Watch for changes to primary resource Cluster Network
...
// ReconcileClusterConfig reconciles a Network object
...
func newPodForCR(cr *configv1.Network) *corev1.Pod {
